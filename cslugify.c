...
static const Locale locales[MAX_LOCALES] = {
    {
        ...
        {
            {L'Й', "Y"}, {L'Ц', "Ts"},
            // Add other Bulgarian locale-specific mappings here ...
        },
        5 // Number of locale-specific entries
    },
    {
        "de",
        {
            {L'Ä', "AE"}, {L'ä', "ae"},
            // Add other German locale-specific mappings here ...
        },
        8 // Number of locale-specific entries
    },
